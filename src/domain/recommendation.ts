...
const resetTime = (window: RecommendationWindow): number | null => {
...
const planRank = (plan: string | undefined): number => {
  if (!plan) {
    return 0;
  }
...
const utilizationAfter = (entry: RankedCandidate): number => {
